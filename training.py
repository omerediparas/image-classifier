...
def train_model(model, device, epochs, loss_fn, optimizer, train_loader, val_loader):
    ...
    for epoch in range(epochs):
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            images = images.to(device)# NOT SURE
            # Move labels to device
            labels = labels.to(device)# NOT SURE
        ...
        torch.save(model.state_dict(), 'models/cifar10_model.pt') # NOT SURE
